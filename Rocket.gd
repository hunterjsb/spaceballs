...
var base_launch_speed = 100  # Minimum launch speed
var max_launch_speed = 1000  # Maximum launch speed
var charge_rate = 200  # How fast the launch speed increases per second
